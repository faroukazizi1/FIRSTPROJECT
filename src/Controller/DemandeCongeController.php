...
final class DemandeCongeController extends AbstractController
{
    ...
    {
        $action = $request->query->get('action'); // 'accept' or 'refuse'
        $id = $request->query->get('id');         // ID of the request
    ...
    #[Route('/{id<\d+>}/edit', name: 'app_demandeconge_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id<\d+>}', name: 'app_demandeconge_show', methods: ['GET'])]
    ...
    #[Route('/{id<\d+>}', name: 'app_demandeconge_delete', methods: ['POST'])]
